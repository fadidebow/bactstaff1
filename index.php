...
<body id="page-top" style="background-color: #001122">
    ...
    <!-- End of Sidebar -->
<div class="container">
  <div style="margin: 70px auto;width: 400px;height: 400px">
    <img src="admindash/img/1.png" style="width: 390px;height: 300px;">
    <br>
    ...
    <a href="userlogin.php" class="btn btn-lg  btn-block f" >User LogIn</a>
    <br>
    <a href="trainerlogin.php" class="btn btn-lg  btn-block f" >Trainer LogIn</a>
    <br>

    <a href="adminlogin.php" class="btn btn-lg  btn-block f" >Admin Login</a>
  </div>
</div>
