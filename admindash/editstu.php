...
$r=mysqli_query($con,"select * from students where id='$x'");
...
?>
        ...
        <form action="editstu.php?id=<?php echo $x; ?>" method="post">
          <label>Student Name : </label>
        <input type="text" value="<?php  echo $row['stuname']; ?>" name="n" class="form-control"><br>
                <label>Student Email : </label>
        <input type="email" value="<?php  echo $row['stuemail']; ?>" name="e" class="form-control"><br>
...
if(isset($_POST['btn']))
{
$r=mysqli_query($con,"update students set stuname='$name', stuemail='$email',password='$pass',groupname='$gn' where id='$x'");

if(isset($r))
{
  echo'
<div class="alert alert-success">
  <h3 >Edit Student Successfully</h3>

  <a href="ms.php" class="btn btn-primary"> back to table</a>
</div>
  ';
}
...
<div class="alert alert-danger">
  <h3 >Edit Student failed try agin</h3>
</div>
  ';
}
}
