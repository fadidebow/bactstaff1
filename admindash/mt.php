...
<div class="container-fluid" style="background-color: rgba(255,255,255,0.9);">
  ...
  <div class="table-responsive">
    ...
    <tbody>
      ...
      $res=mysqli_query($con,"select * from trainers");
...
<tr>
  ...
  <td>'.$row['email'].'</td>
  <td>'.$row['password'].'</td>
  <td><a href="mt.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
  <td><a href="edittrainer.php?id='.$row['id'].'" class="btn btn-primary">Update</a></td>
...
{
  $id=$_GET['id'];
  $t=mysqli_query($con,"delete from trainers where id='$id'");
  if(isset($t))
