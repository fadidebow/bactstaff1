...
<div class="container">
  ...
  border-radius: 20px;">
        ...
        <h2 style="text-align: center;">Add New Trainer</h2>
    ...
    <button name="btn" type="submit" class="btn btn-primary btn-lg"> Save <i class="fa fa-save"></i></button> 
...
if(isset($_POST['btn']))
{
$r=mysqli_query($con,"insert into trainers(name,email,password)
...
<div class="alert alert-success">
  <h3 >Add Trainer Successfully</h3>
</div>
  ';
}
...
<div class="alert alert-danger">
  <h3 >Add Trainer failed try agin</h3>
</div>
  ';
}
}
