...
<li class="nav-item">
   ...
   <li class="nav-item">
    ...
    <!-- End of Sidebar -->
<div class="container">
  <div style="margin: 10px auto;width: 80%;height: 700px;
  background-color: rgba(200,200,200,0.2);padding: 30px;
  border-radius: 20px;">
   
     
        <h2 style="text-align: center;">Add New Link</h2>
       ...
       <br>
        ...
        <input type="text" name="ti" class="form-control"><br>
                <label>Session Day : </label>
        <input type="date" name="dt" class="form-control"><br>
                <label>Session Link : </label>
        <input type="text" name="link" class="form-control"><br>
        


    <button type="submit" name="btn" class="btn btn-primary btn-lg"> Save <i class="fa fa-save"></i></button> 
...
if(isset($_POST['btn']))
{
$r=mysqli_query($con,"insert into links(trainername,groupname,ti,dt,link)
values('$tname','$gr','$ti','$dt','$link')");

if(isset($r))
{
  echo'
<div class="alert alert-success">
  <h3 >Add Link Successfully</h3>
</div>
  ';
}
...
<div class="alert alert-danger">
  <h3 >Add Link failed try agin</h3>
</div>
  ';
}
}
