...
<li class="nav-item">
    ...
    <!-- End of Sidebar -->
<div class="container">
  <div style="margin: 70px auto;width: 80%;height:auto;
  background-color: rgba(200,200,200,0.2);padding: 30px;
  border-radius: 20px;">
   
     
        <h2 style="text-align: center;">Add New Group</h2>
        <hr style="height: 2px;color: white;background-color: white">
     
     <form action="addgroup.php" method="post">
        <label style="color: white">Group Name : </label>
        <input type="text" placeholder="Group name" class="form-control" name="gn"><br>
...
$trainername=isset($_POST['tn'])?$_POST['tn']:'';


if(isset($_POST['btn']))
{
if(!empty($groupname) && !empty($trainername))
{
  $res=mysqli_query($con,"insert into groups(name,trainer)
  values('$groupname','$trainername')");

if(isset($r))
{
  echo'
<div class="alert alert-success">
  <h3 >Add Group Successfully</h3>
</div>
  ';
}
...
<div class="alert alert-danger">
  <h3 >Add Group failed try agin</h3>
</div>
  ';
}
}
