...
<tr>
  ...
  <td>'.$row['ti'].'</td>
   <td>'.$row['dt'].'</td>
  <td><a href="ml.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
  <td><a href="editlink.php?id='.$row['id'].'" class="btn btn-primary">Update</a></td>
...
{
  $id=$_GET['id'];
  $t=mysqli_query($con,"delete from links where id='$id'");
  if(isset($t))
